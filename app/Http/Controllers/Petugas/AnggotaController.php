...
class AnggotaController extends Controller
{
    public function index() {
        ...
        $page = 'anggota';
        $anggota = Anggota::all();
        return view('Petugas.anggota.main',compact('title','page','anggota'));
    }

    public function tambah() {
        $title = 'Form Anggota';
        $page = 'anggota';
        return view('Petugas.anggota.form-anggota',compact('title','page'));
    }
    ...
    public function edit($id) {
        ...
        return view('Petugas.anggota.form-anggota',compact('title','page','row'));
    }
