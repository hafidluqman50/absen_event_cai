...
class AbsenController extends Controller
{
    public function index($id) {
    	...
    	$absen = DB::table('absen')
    				...
    				->get();
    	return view('Petugas.absen.main',compact('absen','title','page','id','kegiatan'));
    }

    public function form($id) {
    	$title = 'Form Absen';
    	$page = 'kegiatan';
    	return view('Petugas.absen.form-absen',compact('title','page','id'));
    }

    public function delete($id,$id_absen) {
    	Absen::where('id_absen',$id_absen)->delete();
    	return redirect('/petugas/kegiatan/'.$id.'/absen')->with('message','Berhasil Hapus Absen');
    }
    ...
    public function save(Request $request) {
    	...
    	Absen::create($array);
    	return redirect('/petugas/kegiatan/'.$id_kegiatan.'/absen')->with('message','Berhasil Input Absen');
    }
}
