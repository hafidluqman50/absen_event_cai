...
Route::group(['prefix'=>'admin','middleware'=>'isAdmin'],function(){
	...
	Route::get('/kegiatan/{id}/peserta/{id}/edit',['as'=>'peserta-tambah-admin','uses'=>'Admin\KegiatanController@editPeserta']);
	Route::get('/kegiatan/{id}/peserta/{id}/delete',['as'=>'peserta-tambah-admin','uses'=>'Admin\KegiatanController@deletePeserta']);
	Route::get('/kegiatan/{id}/absen/tambah',['as'=>'absen-tambah-admin','uses'=>'Admin\PesertaController@tambah']);
	// Route::get('/kegiatan/{id}/absen/edit',['as'=>'absen-tambah-admin','uses'=>'Admin\PesertaController@edit']);
	Route::get('/kegiatan/{id}/absen/{id}/delete',['as'=>'absen-tambah-admin','uses'=>'Admin\PesertaController@delete']);
	...
	Route::get('/users/{id}/status-akun',['as'=>'status-user-admin','uses'=>'Admin\UsersController@statusAkun']);
	// END ACTION //
	...
	Route::post('/profile/save',['as'=>'profile-save-admin','uses'=>'Admin\DashboardController@profileSave']);
	// END PROSES //
...
Route::group(['prefix'=>'petugas','middleware'=>'isPetugas'],function(){
	...
	Route::get('/kegiatan/{id}/peserta',['as'=>'peserta-petugas-page','uses'=>'Petugas\PesertaController@index']);
	...
	Route::get('/kegiatan/{id}/peserta/tambah',['as'=>'peserta-tambah-petugas','as'=>'Petugas\PesertaController@tambah']);
	Route::get('/kegiatan/{id}/peserta/edit',['as'=>'peserta-tambah-petugas','as'=>'Petugas\PesertaController@edit']);
	Route::get('/kegiatan/{id}/peserta/delete',['as'=>'peserta-tambah-petugas','as'=>'Petugas\PesertaController@delete']);
	Route::get('/kegiatan/{id}/absen/tambah',['as'=>'absen-tambah-petugas','as'=>'Petugas\PesertaController@tambah']);
	Route::get('/kegiatan/{id}/absen/edit',['as'=>'absen-tambah-petugas','as'=>'Petugas\PesertaController@edit']);
	Route::get('/kegiatan/{id}/absen/delete',['as'=>'absen-tambah-petugas','as'=>'Petugas\PesertaController@delete']);
	Route::get('/kegiatan/{id}/cetak',['as'=>'cetak-kegiatan-petugas','as'=>'Petugas\KegiatanController@cetak']);
	// END ACTION //
	...
	Route::post('/profile/save',['as'=>'profile-save-petugas','uses'=>'Petugas\DashboardController@profileSave']);
	// END PROSES //
