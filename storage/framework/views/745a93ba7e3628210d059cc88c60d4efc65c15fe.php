...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/datatables/datatables.min.css')); ?>">
    ...
    <link href="<?php echo e(asset('frontend/css/themes/all-themes.css')); ?>" rel="stylesheet" />
</head>
...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?php echo e(asset('frontend/images/ppg.png')); ?>" width="48" height="48" alt="User" />
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?php echo e(route('kelompok.index')); ?>">
    ...
    <!-- Select Plugin Js -->
    <script src="<?php echo e(asset('frontend/plugins/bootstrap-select/js/bootstrap-select.js')); ?>"></script>

    <!-- Slimscroll Plugin Js -->
    <script src="<?php echo e(asset('frontend/plugins/jquery-slimscroll/jquery.slimscroll.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('frontend/datatables/datatables.min.js')); ?>"></script>

    <!-- Demo Js -->
    <script src="<?php echo e(asset('frontend/js/demo.js')); ?>"></script>
    <script>
        $(function(){
            $('#table').DataTable();
        });
