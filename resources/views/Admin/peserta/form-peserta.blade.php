    ...
    <div class="row clearfix">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="body">
                    <form action="{{ url('/admin/peserta/save') }}" method="POST">
                        @csrf
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" class="form-control" name="nama_peserta" value="{{ isset($row) ? $row->nama_peserta : '' }}" required="required">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" name="no_telepon" value="{{ isset($row) ? $row->no_telepon : '' }}">
                        ...
                        <input type="hidden" name="id_kelompok" value="{{ isset($row) ? $row->id_peserta : '' }}">
