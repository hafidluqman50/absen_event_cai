                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ url('/admin/kegiatan/'.$id.'/peserta/'.$data->id_detail.'/edit') }}" title="Edit" class="btn btn-warning waves-effect"><b>Edit</b></a>
                                        </div>
                                        <div class="btn-group" role="button">
                                            <a href="{{ url('/admin/kegiatan/'.$id.'/peserta/'.$data->id_detail.'/delete') }}" title="Hapus" class="btn btn-danger waves-effect" onclick="return confirm('Anda Yakin?')"><b>Hapus</b></a>
                                        </div>
                                        <div class="btn-group" role="button">
                                            <a href="{{ url('/admin/kegiatan/'.$id.'/peserta/'.$data->id_detail.'/cetak-bet') }}" class="btn btn-info waves-effect" target="_blank"><b>Cetak Bet</b></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
